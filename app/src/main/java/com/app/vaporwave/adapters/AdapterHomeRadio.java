...
public class AdapterHomeRadio extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterHomeRadio(Context context, ArrayList<Radio> items) {
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home_radio, parent, false);
